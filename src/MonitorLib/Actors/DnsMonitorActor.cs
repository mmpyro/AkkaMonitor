...
using InitParameters = MonitorLib.Messages.CreateDnsMonitorMessage;
...
namespace MonitorLib.Actors
{
    public class DnsMonitorActor : MonitorActor
    {
        ...
        public DnsMonitorActor(InitParameters parameters, IDnsRequest dnsRequest) : base(parameters)
        {
